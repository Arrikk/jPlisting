...
<div class="col-12">
        ...
        <div class="card-body">
            <div class="d-flex flex-wrap justify-content-between align-items-center" id="menu-navi">
                <div class="d-flex align-items-center my-1">
                    <button class="btn bg-secondary text-light me-2 lnb-new-schedule-btn" id="btn-new-schedule" type="button" data-bs-toggle="modal">New schedule</button>
    ...
    <!-- Plugin Js -->
    <script src="/Public/assets/js/bundle/tui-calendar.bundle.js"></script>
    <!-- Jquery Page Js -->
    <script>
    </script>
</div>